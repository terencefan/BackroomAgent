...
def main():
    parser = argparse.ArgumentParser(description="Run Level Agent to fetch, process, and extract items from a Level.")
    parser.add_argument("url_or_name", nargs="?", help="URL of the wiki page OR local level name (e.g., 'level-1')")
    parser.add_argument("--force", action="store_true", help="Force regeneration of JSON and re-extraction of items")
