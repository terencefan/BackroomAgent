...
def run_batch_levels(start, end):
    ...
    log_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "tmp", "batch_run.log")
    ...
    for i in range(start, end + 1):
        ...
        try:
            ...
            result = subprocess.run(
                [python_executable, script_path, level_name, "--force"],
                check=True,
                text=True,
