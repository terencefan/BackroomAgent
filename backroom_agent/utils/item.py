...
class Item:
    ...
    """
    def __init__(self, name: str, description: str = "", item_id: str = "", category: str = "General", quantity: int = 1):
        self.name = name
    ...
    def to_json(self, include_quantity: bool = True) -> str:
        ...
        return json.dumps(self.to_dict(include_quantity=include_quantity), ensure_ascii=False, indent=2)
