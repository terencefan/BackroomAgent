...
def generate_level_graph():
        ...
        if len(src_edges) > 5:
            ...
            for edge in main_edges:
                ...
                if dst not in known_ids:
                    ...
                    dot.node(safe_dst, label=dst, style='filled,dashed', fillcolor='lightgrey')
                    known_ids.add(dst)
            ...
            dot.node(summary_node_id, label=summary_label, shape='ellipse', style='dashed')
            ...
            for edge in other_edges:
                ...
                short_method = method[:20] + "..." if len(method) > 20 else method
                dot.edge(summary_node_id, safe_dst, label=short_method, style='dashed', color='grey')
    ...
    try:
        ...
        print("Ensure 'dot' is installed on your system (e.g. 'brew install graphviz').")
